...
public class BankingTest {
    public static void main(String[] args) {
        ...
        //code
        Account savingAccount = new SavingsAccount(500,0.03);//
        ...
        //code
        Account checkingAccount1 =new CheckingAccount(500,500);
        customer.setAccount(checkingAccount1);
